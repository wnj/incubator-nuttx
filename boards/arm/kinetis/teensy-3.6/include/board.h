/****************************************************************************
 * boards/arm/kinetis/teensy-36/include/board.h
 *
...
#ifndef __BOARDS_ARM_KINETIS_TEENSY_36_INCLUDE_BOARD_H
#define __BOARDS_ARM_KINETIS_TEENSY_36_INCLUDE_BOARD_H
...
/* The Teensy 3.6  uses a 16Mhz external Oscillator.
 ...
 * The default external source for the MCG oscillator inputs is 16 MHz
 * oscillator
 *
 ...
 * clock to the PLL.
 *
 *   PLL Input frequency:   PLLIN  = REFCLK / PRDIV = 16 MHz  / 2  = 8 MHz
 *   PLL Output frequency:  PLLOUT = PLLIN  * VDIV  = 8 MHz  * 45 = 360 MHz
...
#define BOARD_VDIV           45   /* PLL VCO Divider (frequency multiplier) */
...
/* N.B. The above BOARD_SOPT2_FREQ precludes use of USB with a 16 MHz Xtal
...
/* The Teensy 3.6  has a single LED driven by the K66F as follows:
 *
 *   LED    K66
 *   ------ -------------------------------------------------------
 *   RED    PTC5
...
#endif /* __BOARDS_ARM_KINETIS_TEENSY_36_INCLUDE_BOARD_H */
